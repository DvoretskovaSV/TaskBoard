...
Ext.define('Ext.chart.AbstractChart', {
    ...
    config: {
        ...
        /**
         * @private
         * The board area of the chart where grid and series are drawn.
         */
        mainRect: null,
    ...
    */
    ...
    // Converts page coordinates into chart's 'board' surface coordinates.
    ...
    getItemForPoint: function (x, y) {
        ...
        // The x,y here are already converted to the 'board' surface coordinates.
        // Series surface rect matches the board surface rect.
