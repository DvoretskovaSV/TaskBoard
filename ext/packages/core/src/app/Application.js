...
Ext.define('Ext.app.Application', {
     ...
     *      });
     *
     * You don't need to include board namespace (MyApp), it will be added to the list
     * automatically.
     */
    namespaces: [],
    ...
    config: {
         ...
         * The name of a property to be assigned to the board namespace to gain a reference to
        ...
        */
         ...
         * The application class to be used as the board viewport view for the
         * application.  The view will be configured with the
         * {@link Ext.plugin.Viewport viewport plugin} to ensure the view takes up all
         * available space in the browser viewport.  The board view will be created after
         * the application's {@link #init} method is called and before the
         * {@link #launch} method.  The board view should be an application class type and
         * not a class from the framework.
         *
         * The board view value may be:
         *  - string representing the full class name of the board view or the partial class name following "AppName.view." (provided your board view class follows that convention).
         *  - config object for the board view
         *  - board view class instance
         *
         *     Ext.define('MyApp.view.board.Main', {
         ...
         *         name : 'MyApp',
         *
         *         mainView: 'MyApp.view.board.Main'
         *         // mainView: 'board.Main'
         *         // mainView: new MyApp.view.board.Main()
         ...
         * the creation of the board view.
         */
        mainView: {
            $value: null,
            lazy: true
