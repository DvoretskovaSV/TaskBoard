 ...
 *     });
 *
 * In this case, the Profile is going to load *app/view/phone/Board.js*, *app/controller/phone/Signup.js* and
...
Ext.define('Ext.app.Profile', {
    ...
    config: {
         ...
         *
         *      views: {
         *          // The "board" xtype maps to MyApp.view.tablet.Main
         *          //
         *          board: 'MyApp.view.tablet.Main',
         *
