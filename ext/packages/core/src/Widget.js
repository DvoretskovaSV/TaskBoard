...
Ext.define('Ext.Widget', {
    ...
    cachedConfig: {
         ...
         * only horizontal scrolling and pinch-to-zoom on the component's board element:
         *
         *     touchAction: {
         *         panX: false,
         *         pinchZoom: false
         ...
         * name, for example:
         *
         *     // disables horizontal scrolling on the board element, and double-tap-zoom
     ...
     * An array of child elements to use as the children of the board element in the {@link
    ...
    /**
     * A CSS class to apply to the board element that will be inherited down the class
