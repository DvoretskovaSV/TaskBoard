describe("Ext.Widget", function() {
    ...
    function makeSuite(first) {
        ...
        describe(first ? "first instance" : "second instance", function() {
            it("should have an element when 'element' reference is defined on the board element", function() {
                defineWidget(first);
            ...
            it("should allow the 'element' reference to be a descendant of the board template element", function() {
                defineWidget(first, {
                    element: {
                        children: [{
                            cls: 'foo',
            ...
            it("should add a listener to the board element", function() {
