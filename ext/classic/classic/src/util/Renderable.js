...
Ext.define('Ext.util.Renderable', {
     ...
     *
     * Most of the simple Components will have their board element as ariaEl.
     *
     * @private
     * @readonly
     * @since 6.0.0
    ...
    getElConfig: function() {
        ...
        if (config.tpl) {
            // Use the framingTpl as the board content creating template. It will call out to this.applyRenderTpl(out, values)
            if (frameInfo) {
    ...
    privates: {
        ...
        applyRenderSelectors: function() {
            ...
            // For the majority of Components, their ariaEl is going to be their board el.
