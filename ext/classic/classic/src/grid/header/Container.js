...
Ext.define('Ext.grid.header.Container', {
    ...
    onColumnsChanged: function() {
        ...
        if (me.rendered) {
            ...
            // It will be recreated just before the board container menu is next shown.
            if (menu) {
    ...
    beforeMenuShow: function(menu) {
        ...
        // or the board menu was created without the column menu item because it began with no hideable headers
