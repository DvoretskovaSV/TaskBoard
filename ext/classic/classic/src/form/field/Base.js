 ...
 *
 * Because Base implements the Field mixin, it has a board value that can be initialized with the
 * {@link #value} config and manipulated via the {@link #getValue} and {@link #setValue} methods. This board
 ...
 *
 * Conversion back and forth between the board value and the raw value is handled by the {@link #valueToRaw} and
...
Ext.define('Ext.form.field.Base', {
     ...
     * The CSS class applied to the component's board element when it is {@link #readOnly}.
     */
    ...
    /**
     * @private
     * Called when the field's dirty state changes. Adds/removes the {@link #dirtyCls} on the board element.
