 ...
 * # Values
 *
 * The board value of a checkbox is a boolean, indicating whether or not the checkbox is checked.
 ...
 *
 * In addition to the board boolean value, you may also specify a separate {@link #inputValue}. This will be
...
Ext.define('Ext.form.field.Checkbox', {
     ...
     * The CSS class(es) added to the component's board element when it is in the checked state.
