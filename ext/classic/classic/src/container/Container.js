 ...
 *         }]
 *     });
 *     // The board container will not have references to a/b, each innerCt will
...
Ext.define('Ext.container.Container', {
    ...
    getComponent: function(comp) {
        ...
        // Only allow finding by index on the board items container
    ...
    privates: {
        ...
        // children are rendered and is usually just the board el. Some containers (e.g. panels) use a body instead.
        //
