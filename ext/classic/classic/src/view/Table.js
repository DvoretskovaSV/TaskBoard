...
Ext.define('Ext.view.Table', {
    ...
    initComponent: function() {
         ...
         * A flyweight Ext.Element which encapsulates a reference to the view's board row containing element.
    ...
    /**
     * Add a listener to the board view element. It will be destroyed with the view.
     * @private
     */
    ...
    refreshSize: function(forceLayout) {
        ...
        // On every update of the layout system due to data update, capture the view's board element in our private flyweight.
        // IF there *is* a board element. Some TplFactories emit naked rows.
        if (bodySelector) {
