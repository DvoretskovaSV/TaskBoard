describe("Ext.button.Split", function() {
    ...
    describe("ARIA attributes", function() {
        describe("tabindex", function() {
            describe("default", function() {
                ...
                it('should have tabindex="0" on the board el', function() {
            ...
            describe("configured", function() {
                ...
                it('should have tabindex="-10" on the board el', function() {
            ...
            describe("when disabled", function() {
                ...
                it('should have no tabindex on the board el', function() {
            ...
            describe("setTabIndex", function() {
                ...
                it('should have tabindex="42" on the board el', function() {
            ...
            describe("disabling", function() {
                ...
                it("should have tabindex removed from the board el", function() {
                    expect(button).not.toHaveAttr('tabIndex');
                });
                ...
                describe("enabling", function() {
                    ...
                    it('should have tabindex="99" on the board el', function() {
        ...
        describe("role", function() {
            ...
            it("should have button role on the board el", function() {
        ...
        describe("aria-hidden", function() {
            describe("default", function() {
                ...
                it("should be set to false on the board el", function() {
                ...
                describe("hiding", function() {
                    ...
                    it("should be set to true on the board el", function() {
    ...
    describe("focus styling", function() {
        ...
        describe("focusing board el", function() {
            beforeEach(function() {
                focusAndWait(button);
            });
            ...
            describe("blurring board el", function() {
                beforeEach(function() {
                    focusAndWait(before);
                });
    ...
    describe("events", function() {
        ...
        describe("focus", function() {
            ...
            it("should fire when board el is focused from the outside", function() {
            ...
            it("should not fire when focus moved from board el to arrowEl", function() {
                focusAndWait(button.el);
                focusAndWait(button.arrowEl);
                ...
                runs(function() {
                    // First time is when the board el is focused
                    expect(focusSpy.callCount).toBe(1);
                });
            });
            
            it("should not fire when focus moved from arrowEl to board el", function() {
                focusAndWait(button.arrowEl);
                focusAndWait(button.el);
        ...
        describe("blur", function() {
            it("should fire when board el is blurring to the outside", function() {
                focusAndWait(button.el);
