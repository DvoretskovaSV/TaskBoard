describe("Ext.form.field.Checkbox", function() {
    ...
    describe("rendering", function() {
        // NOTE this doesn't test the board label, error icon, etc. just the parts specific to Checkbox.
    ...
    describe("css styling", function() {
        ...
        describe("checked", function() {
            it("should not have checked cls on board el when not checked", function() {
                expect(component.el.hasCls('x-form-cb-checked')).toBe(false);
            });
            
            it("should have checked cls on board el when checked", function() {
                component.setValue(true);
    ...
    describe("interaction", function() {
        ...
        (Ext.isIE9m ? xdescribe : describe)("pointer", function() {
            describe("on inputEl", function() {
                ...
                it("should have checked cls on board el", function() {
                    expect(component.el.hasCls('x-form-cb-checked')).toBe(true);
                });
                ...
                describe("second click", function() {
                    ...
                    it("should reset checked cls on board el", function() {
                        expect(component.el.hasCls('x-form-cb-checked')).toBe(false);
                    });
                });
            });
