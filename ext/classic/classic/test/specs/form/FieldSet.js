describe("Ext.form.FieldSet", function() {
    ...
    describe("rendering", function() {
        ...
        it("should have a fieldset as the board element", function(){
    ...
    describe("collapse method", function() {
        ...
        it("should give the board element a class of 'x-fieldset-collapsed'", function() {
            makeComponent({collapsed: false});
            component.collapse();
    ...
    describe("expand method", function() {
        ...
        it("should remove the 'x-fieldset-collapsed' class from the board element", function() {
            makeComponent({collapsed: true});
            component.expand();
